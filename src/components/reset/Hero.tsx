...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(135deg, #1a1a1a, #2d2d2d)' }}>
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,hsl(var(--nxt-teal))_0%,transparent_50%)] opacity-5"></div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-nxt-white mb-6 leading-tight">
            ...
            <span className="block text-nxt-teal">12 Weeks</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" size="lg" className="border-nxt-teal bg-transparent text-nxt-teal hover:bg-nxt-teal hover:text-nxt-white px-8 py-4 text-lg transition-nxt" asChild>
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-8 text-nxt-white/60">
            <div className="flex items-center gap-2">
              <span className="text-nxt-teal text-2xl">✓</span>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-nxt-white/30 rounded-full flex justify-center">
          <div className="w-1 h-3 bg-nxt-teal rounded-full mt-2"></div>
        </div>
      </div>
    </section>
  );
