const Outcomes = () => {
  ...
  return (
    <section className="py-20 bg-gradient-hero relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,hsl(var(--nxt-orange))_0%,transparent_50%)] opacity-10"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Long-term Benefits */}
        <div className="text-center bg-nxt-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto">
