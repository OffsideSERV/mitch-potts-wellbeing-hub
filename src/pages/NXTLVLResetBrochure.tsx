    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #1a1a1a, #2d2d2d)' }}>
        ...
        <div className="container mx-auto px-4 py-8">
          <Link to="/nxtlvl-reset" className="inline-flex items-center gap-2 text-nxt-orange hover:text-nxt-orange-light transition-nxt mb-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-nxt-white mb-4">
              Program <span className="text-nxt-orange">Brochure</span>
            </h1>
        ...
        <div className="container mx-auto px-4 pb-16">
          <div className="max-w-5xl mx-auto space-y-8">
            <div className="rounded-xl overflow-hidden shadow-2xl border border-white/10">
              <img
                src="/lovable-uploads/trifold-brochure-front.png"
            ...
            <div className="rounded-xl overflow-hidden shadow-2xl border border-white/10">
              <img
                src="/lovable-uploads/trifold-brochure-inside.png"
                alt="NXTLVL Reset Brochure - Inside"
                className="w-full h-auto"
              />
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <h2 className="text-2xl md:text-3xl font-bold text-nxt-white mb-4">
              Ready to <span className="text-nxt-orange">Get Started?</span>
            </h2>
