  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        {/* Header */}
        <section className="py-12" style={{ background: 'linear-gradient(135deg, hsl(180 45% 50%), hsl(180 50% 60%))' }}>
          <div className="container mx-auto px-4">
            <Link to="/nxtlvl-reset" className="inline-flex items-center text-nxt-white/80 hover:text-nxt-white mb-8 transition-colors">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-3xl md:text-5xl font-bold text-nxt-white mb-4">
                NXTLVL Reset <span className="text-nxt-black">Brochure</span>
              </h1>
              <p className="text-lg text-nxt-white/90 mb-8">
                Everything you need to know about our 12-week health transformation program.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-nxt-black hover:bg-nxt-black/90 text-nxt-white font-semibold" asChild>
                  <a href="https://nxtlvl-health-quiz.scoreapp.com" target="_blank" rel="noopener noreferrer">
                    Take the Health Quiz
                  </a>
                </Button>
                <Button variant="outline" size="lg" className="border-nxt-white bg-nxt-white text-nxt-black hover:bg-nxt-black hover:text-nxt-white hover:border-nxt-black" asChild>
        ...
        <section className="py-16 bg-nxt-black">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-nxt-teal hover:bg-nxt-teal-light text-nxt-black font-semibold" asChild>
                  <a href="https://nxtlvl-health-quiz.scoreapp.com" target="_blank" rel="noopener noreferrer">
                    Take the 5-minute Health Quiz
                  </a>
                </Button>
                <Button variant="outline" size="lg" className="border-nxt-white bg-nxt-white text-nxt-black hover:bg-nxt-teal hover:border-nxt-teal" asChild>
                  <a href="https://calendly.com/nxtlvlhealth-info/nxtlvl-30-15-min-call" target="_blank" rel="noopener noreferrer">
                    <Calendar className="mr-2 h-5 w-5" />
