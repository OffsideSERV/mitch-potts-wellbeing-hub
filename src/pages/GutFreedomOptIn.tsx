            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Finally Fix Your{" "}
                  <span className="text-green-600">Gut Issues</span> Once and For All
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Discover the root cause of your bloating, gas, and digestive problems with this comprehensive 15-minute video guide from Brisbane's leading gut health specialist.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">How proper chewing and stomach acid optimization can eliminate bloating and gas</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-3 text-xl">✓</span>
                    <span className="text-gray-700">The "stress switch" that controls your digestion and how to activate "rest and digest" mode</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-3 text-xl">✓</span>
                    <span className="text-gray-700">Why your gut wall might be "leaky" and the exact nutrients needed to heal it</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-3 text-xl">✓</span>
                    <span className="text-gray-700">The difference between SIBO, IBS, IBD and how to address each condition naturally</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-3 text-xl">✓</span>
                    <span className="text-gray-700">Simple dietary changes and targeted supplements that restore healthy gut bacteria</span>
                  </li>
                </ul>
              </div>
            </div>
                    ...
                    dangerouslySetInnerHTML={{
                      __html: `
                        ...
                        <form method="POST" action="https://nxtlvlhealth.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form  _dark" novalidate data-styles-version="5">
                          ...
                          <input type="hidden" name="or" value="f65b7e5c8cded5d37c49dfa106bd22ac" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Science-Based</h3>
              <p className="text-gray-600">
                Every recommendation is backed by the latest research in gut health and functional medicine.
              </p>
            </div>
            <div className="space-y-4">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Quick to Implement</h3>
              <p className="text-gray-600">
                Simple, actionable steps you can start implementing today to see immediate results.
              </p>
            </div>
            <div className="space-y-4">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Root Cause Focus</h3>
              <p className="text-gray-600">
                Address the underlying causes of gut issues, not just mask the symptoms.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600">
              Join thousands who have already transformed their gut health
            </p>
          </div>
              ...
              <div 
                dangerouslySetInnerHTML={{
                  __html: `
                    ...
                    <form method="POST" action="https://nxtlvlhealth.activehosted.com/proc.php" id="_form_2_" class="_form _form_1 _inline-form  _dark" novalidate data-styles-version="5">
                      <input type="hidden" name="u" value="1" />
                      <input type="hidden" name="f" value="1" />
                      <input type="hidden" name="s" />
                      <input type="hidden" name="c" value="0" />
                      ...
                      <div class="_form-content">
                        ...
                        <div class="_form_element _x28172720 _full_width " >
                          <label for="fullname2" class="_form-label">
                            Name<span class="field-required">
                            *
                          </span>
                        </label>
                        <div class="_field-wrapper">
                          <input type="text" id="fullname2" name="fullname" placeholder="Type your name" required/>
                        </div>
                      </div>
                      <div class="_form_element _x51149711 _full_width " >
                        <label for="email2" class="_form-label">
                          Email<span class="field-required">
                          *
                        </span>
                      </label>
                      <div class="_field-wrapper">
                        <input type="text" id="email2" name="email" placeholder="Type your email" required/>
                      </div>
                    </div>
                    <div class="_button-wrapper _full_width">
