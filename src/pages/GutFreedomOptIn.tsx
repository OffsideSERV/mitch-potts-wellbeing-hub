            ...
            <div dangerouslySetInnerHTML={{
              __html: `
                ...
                <div style="text-align: center;">
                  <form method="POST" action="https://nxtlvlhealth.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form _inline-style _dark" novalidate data-styles-version="5">
                    ...
                    <div class="_form-content">
                      <div class="_form_element _x09077243 _inline-style _clear" >
                        <title class="_form-title">
                          Get Answers To Your Bloating With This Easy 15-Min Gut Health Video Guide
                        </title>
                      </div>
                      <div class="_form_element _x44556073 _inline-style _clear" >
                      ...
                      <div class="_form_element _x28172720 _inline-style " >
                    ...
                    <div class="_form_element _x51149711 _inline-style " >
