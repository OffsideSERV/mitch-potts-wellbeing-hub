...
const WeightLoss = () => {
  ...
  return <>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Are You Struggling to Lose Weight Despite Doing Everything "Right"?</h2>
          </div>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Why Naturopathic Weight Loss Actually Does Work</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {["Feel like you're doing everything right, but the scale won't move", "Experience fluid retention, stubborn belly fat, or chronic bloating", <>Have <a href="https://my.clevelandclinic.org/health/diseases/8541-thyroid-disease" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 underline">thyroid dysfunction</a>, PCOS, or are in peri/menopause</>, "Struggle with fatigue, mood swings, or low motivation", "Experience emotional eating or blood sugar crashes", "Have a history of chronic fatigue, digestive health issues, or cardiovascular disease"].map((item, index) => <li key={index} className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-muted-foreground">{item}</span>
                  </li>)}
              </ul>
              <div className="mt-6 p-6 bg-primary/10 rounded-lg">
                <p className="text-lg font-medium text-foreground">If any of the above sounds like you, working with a qualified naturopath could be the next step toward healthy weight loss for you.</p>
              </div>
            </div>
            {/* Desktop Image */}
            <div className="relative hidden lg:block">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2">
                    {["Hormone testing (cortisol, oestrogen, thyroid hormones)", "Food Intolerance testing", "Blood tests for nutrient status, inflammation, or metabolic imbalances", "Body composition scans to assess muscle mass and fat percentage", "Tests for Heavy Metal load or Digestive Health markers"].map((item, index) => <li key={index} className="flex items-start space-x-2">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2 mb-4">
                    {["Herbal remedies to support hormone balance and appetite regulation", "Natural supplements for metabolism, cravings, and energy levels", "A sustainable meal plan designed for fat loss and hormone health", "Stress management and nervous system support", "Guidance for lifestyle changes and regular exercise that won't burn you out"].map((item, index) => <li key={index} className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                        <span className="text-muted-foreground text-sm">{item}</span>
                      </li>)}
                  </ul>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {["Hormone imbalances (thyroid, insulin, oestrogen, cortisol)", "Metabolic Syndrome and insulin resistance", "Gut health conditions linked to weight gain", "Chronic stress and mental health concerns", "Autoimmune conditions that affect metabolic process"].map((condition, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
