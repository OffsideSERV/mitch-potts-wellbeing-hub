...
const NewsteadNaturopathy = () => {
  return (
    <>
      <Helmet>
        <title>Top Naturopath in Newstead Brisbane | Mitchell Potts</title>
        <meta name="description" content="Not feeling like yourself and not getting answers? Mitchell is a 5-star Naturopath in Newstead Brisbane that will find and heal the root cause of your problems." />
      </Helmet>
