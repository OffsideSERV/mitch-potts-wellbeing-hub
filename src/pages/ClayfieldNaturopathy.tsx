...
const ClayfieldNaturopathy = () => {
  return (
    <>
      <Helmet>
        <title>Best Naturopath Clayfield | Book a Free 15-Min Consult!</title>
        <meta name="description" content="Not feeling like yourself and not getting answers? Mitchell is a 5-star Naturopath in Clayfield that will find and heal the root cause of your problems." />
      </Helmet>
