  ...
  return <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
            <div className="space-y-8 lg:mt-0 mt-12">
              <div className="space-y-4">
                ...
                <div className="relative lg:hidden mb-8 -mx-4">
                  <LazyImage alt="Naturopath having consultation with female patient at NXTLVL Health" className="rounded-2xl shadow-2xl w-full h-auto max-h-96 object-cover" src="/lovable-uploads/f459679d-99b6-4b58-affb-e2cedb040e6e.png" />
            ...
            <div className="relative hidden lg:block">
              <LazyImage alt="Naturopath having consultation with female patient at NXTLVL Health" className="rounded-2xl shadow-2xl w-full h-auto" src="/lovable-uploads/f459679d-99b6-4b58-affb-e2cedb040e6e.png" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/9e5ed0a0-bb35-4fde-9965-94edcb9294a8.png" alt="Woman dealing with health concerns needing naturopathic care" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <LazyImage src="/lovable-uploads/7f8808bd-07aa-4759-8e99-de3701adb7e7.png" alt="Woman consulting with Brisbane naturopath at NXTLVL Health" className="rounded-2xl shadow-lg w-full h-auto" />
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/29a3a739-d347-46de-b287-0c187b12d5b7.png" alt="Naturopath performing live blood analysis at NXTLVL Health Brisbane" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/889bad55-c07b-401c-8b1d-ee0484fff02d.png" alt="Naturopath checking patient vitals at NXTLVL Health" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/17548d2b-e4a0-4571-aba5-1705f04c994e.png" alt="Natural health services at NXTLVL Health Brisbane" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/61e65ac0-1104-41b0-8fad-b262f20e0290.png" alt="Health conditions we help with at NXTLVL Health" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/87b88ea1-0f03-408b-89c7-477dbb81bc30.png" alt="Children's naturopathic health care" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <LazyImage src="/lovable-uploads/eb18265f-6c19-482a-a611-fefbc994ee40.png" alt="Mitch Potts - Best naturopath in Brisbane" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
