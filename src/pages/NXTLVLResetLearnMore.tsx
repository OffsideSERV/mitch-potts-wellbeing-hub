    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #1a1a1a, #2d2d2d)' }}>
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,hsl(var(--nxt-teal))_0%,transparent_50%)] opacity-5" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-nxt-white mb-10">
                Does this feel <span className="text-nxt-teal">familiar?</span>
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-xl p-5">
                    <item.icon className="h-6 w-6 text-nxt-teal flex-shrink-0 mt-1" />
              ...
              <div className="mt-12 text-center">
                <p className="text-2xl md:text-3xl font-bold text-nxt-white mb-2">
                  Your body is asking for a <span className="bg-nxt-teal text-nxt-white px-3 py-1 rounded-md font-extrabold">RESET</span>
                </p>
                <p className="text-nxt-teal text-xl mt-4 font-medium">You can feel better than this.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-14">
                <h2 className="text-3xl md:text-5xl font-bold text-nxt-white mb-4">
                  A Clear Framework That <span className="text-nxt-teal">Restores Your Body</span> Step by Step
                </h2>
              ...
              <div className="space-y-8">
                {[
                  { phase: "Phase 1", weeks: "Weeks 1–4", title: "Detox & Foundation", summary: "Calm the gut, lower inflammation and reset your system. This is where your body begins to let go of the overwhelm.", detail: "During this foundational phase, we focus on removing dietary triggers, introducing targeted supplements to reduce gut inflammation, and establishing the daily habits that will carry you through the full 12 weeks. You'll begin to notice improved digestion, reduced bloating, and a clearer headspace as your body starts to detoxify and recalibrate." },
                  { phase: "Phase 2", weeks: "Weeks 5–8", title: "Gut & Nervous System Reset", summary: "Repair the gut lining, support digestion and rebuild stress balance. Your energy begins to lift and your body starts to feel lighter.", detail: "With the foundation in place, Phase 2 targets deeper gut repair — restoring the intestinal lining, rebalancing gut flora, and calming your nervous system. You'll work on stress resilience techniques, optimise your nutrition plan, and start to feel a real shift in energy, mood, and mental clarity. This is where the transformation truly accelerates." },
                  { phase: "Phase 3", weeks: "Weeks 9–12", title: "Integration & Resilience", summary: "Build routines that last. Strengthen your body and mind. This is where you regain confidence in your health and yourself.", detail: "The final phase is all about locking in your results for the long term. You'll solidify the habits, nutrition strategies, and movement patterns that keep you feeling your best. We focus on building resilience — both physical and mental — so you leave the program empowered, confident, and equipped with a sustainable health blueprint that lasts well beyond the 12 weeks." },
                ].map((p, i) => (
                  <Card key={i} className="bg-white/5 border-white/10 overflow-hidden">
                    <CardContent className="p-8">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="bg-nxt-teal text-nxt-white font-bold text-sm px-3 py-1 rounded-full">{p.phase}</span>
                        <span className="text-nxt-white/50 text-sm">{p.weeks}</span>
                      </div>
                      <h3 className="text-2xl md:text-3xl font-bold text-nxt-white mb-4">{p.title}</h3>
                      <p className="text-nxt-white/80 text-lg mb-4">{p.summary}</p>
                      <p className="text-nxt-white/60">{p.detail}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                  <span className="text-nxt-teal font-semibold text-sm uppercase tracking-wider mb-2 block">Your Practitioner</span>
                  <h2 className="text-3xl md:text-4xl font-bold text-nxt-white mb-6">
                    Led by Naturopath<br />
                    <span className="text-nxt-teal">Mitchell Potts (BHSc)</span>
                  </h2>
                  ...
                  <p className="text-nxt-white/70 mb-6">Mitchell has helped hundreds of clients to:</p>
                  <ul className="space-y-3">
                    {["Overcome fatigue & burnout", "Improve gut health & digestion", "Sleep better & manage stress", "Rebuild strength & mood", "Create sustainable routines that last long-term"].map((item, i) => (
                      <li key={i} className="flex items-center gap-3 text-nxt-white/90">
                        <CheckCircle className="h-5 w-5 text-nxt-teal flex-shrink-0" />
                        {item}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    <div className="absolute -inset-4 bg-nxt-teal/20 rounded-2xl blur-xl" />
                    <img src="/lovable-uploads/naturopath-consultation-mitch.png" alt="Mitchell Potts - Naturopath & NXTLVL Reset Creator" className="relative rounded-2xl w-full max-w-md shadow-2xl" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 md:py-20" style={{ background: '#111' }}>
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-14">
                <h2 className="text-3xl md:text-5xl font-bold text-nxt-white mb-4">
                  What's <span className="text-nxt-teal">Included?</span>
                </h2>
                <p className="text-nxt-white/70 text-lg max-w-3xl mx-auto">
              ...
              <div className="mb-12">
                <h3 className="text-xl font-bold text-nxt-teal mb-6 uppercase tracking-wider">Core Inclusions</h3>
                    ...
                    <Card key={i} className="bg-white/5 border-white/10">
                      <CardContent className="p-5">
                        <div className="flex items-start gap-3">
                          <CheckCircle className="h-5 w-5 text-nxt-teal flex-shrink-0 mt-1" />
                          <div>
              ...
              <div>
                <h3 className="text-xl font-bold text-nxt-teal mb-6 uppercase tracking-wider">Also Included</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    <Card key={i} className="bg-white/5 border-white/10">
                      <CardContent className="p-5">
                        <div className="flex items-start gap-3">
                          <item.icon className="h-5 w-5 text-nxt-teal flex-shrink-0 mt-1" />
                          <div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-bold text-nxt-white mb-6">
                Feel <span className="text-nxt-teal">Lighter, Clearer</span> and More Energised in Just 12 Weeks
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-6">
                    <p className="text-4xl font-bold text-nxt-teal mb-2">{stat.value}</p>
        ...
        <section className="py-16 md:py-20" style={{ background: '#1a1a1a' }}>
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-5xl font-bold text-nxt-white mb-6">
                Ready to <span className="text-nxt-teal">Reset?</span>
              </h2>
