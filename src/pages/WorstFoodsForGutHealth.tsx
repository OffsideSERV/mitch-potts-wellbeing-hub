            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <div className="mb-12">
                ...
                <div className="text-muted-foreground space-y-4">
                  <p>Hey, it's Mitch here from NXTLVL Health, working online with clients across New Farm and greater Brisbane.</p>
                  <p>Let's talk gut health.</p>
                  <p>If you're feeling bloated, constipated, tired, moody, or just not quite right, your gut might be the reason why. I see it every week in practice, gut health affects everything. And one of the biggest things that hurts your gut? The food you're eating.</p>
