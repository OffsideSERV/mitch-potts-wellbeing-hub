  ...
  return <>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
            <div className="space-y-8 lg:mt-0 mt-12">
              <div className="space-y-4">
                ...
                <div className="relative lg:hidden mb-8 -mx-4">
                  <img alt="Naturopath consultation at NXTLVL Health near Morningside" className="rounded-2xl shadow-2xl w-full h-auto max-h-96 object-cover" src="/lovable-uploads/4c05f756-6f70-466c-b4f4-5f0fd25a5d07.png" />
            ...
            <div className="relative hidden lg:block">
              <img alt="Naturopath consultation at NXTLVL Health near Morningside" className="rounded-2xl shadow-2xl w-full h-auto" src="/lovable-uploads/4c05f756-6f70-466c-b4f4-5f0fd25a5d07.png" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Are You Looking for a Naturopath Near Morningside?</h2>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {["Real answers, not just quick fixes", "A practitioner who listens", "Support for hormonal issues, fertility, anxiety, and fatigue", "Help with conditions like menopause, PCOS, acne, and digestive problems", "To feel like themselves again"].map((item, index) => <Card key={index}>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            {["Gut health concerns (IBS, bloating, reflux, constipation)", "Women's health (menstrual issues, menopause, fertility, pregnancy support)", "Hormone imbalance (PMS, acne, PCOS, post-pill recovery)", "Mental health (anxiety, low mood, burnout)", "Fatigue and chronic fatigue", "Weight loss and healthy metabolism support", "Skin conditions (eczema, acne, perioral dermatitis)"].map((condition, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {["Take a whole-body approach", "Look for the root cause of symptoms", "Use herbal medicine, nutrition, and natural therapies", "Offer personalised support, not generic plans"].map((item, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-muted-foreground">{item}</span>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {["Targeted nutritional therapy", "Herbal medicine tailored to your body", "Gut health and digestive support", "Stress and mental health strategies", "Functional testing (if needed)", "Ongoing support to help you feel your best"].map((service, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            {["A natural way to manage health", "To understand what's going on in their body", "A plan that's easy to follow", "Real results and support"].map((item, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-muted-foreground">{item}</span>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            {["Backed by science", "Rooted in experience", "Tailored just for you", "Driven by real results"].map((item, index) => <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-muted-foreground">{item}</span>
