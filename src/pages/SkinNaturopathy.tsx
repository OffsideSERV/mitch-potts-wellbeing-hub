...
const SkinNaturopathy = () => {
  return (
    <>
      <Helmet>
        <title>Naturopathy for Skin Conditions | The Best in Brisbane</title>
        <meta name="description" content="Skin breaking out and have no idea why? No problem, Mitch's naturopathy for skin treatment will finally give you answers. Book a free 15-min consult today!" />
      </Helmet>
