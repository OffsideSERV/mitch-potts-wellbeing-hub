...
const GutMicrobiomeMentalHealth = () => {
  return <>
      <SEO title="Gut Microbiome and Mental Health | Whats the Real Link?" description="Your gut microbiome helps make the chemicals that steady your mood. See the research, the warning signs and how to feed better bacteria every day." canonical="/gut-microbiome-mental-health" keywords="gut microbiome, mental health, gut-brain axis, depression, anxiety, probiotics, gut health, microbiome diversity, psychobiotics" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg leading-relaxed mb-6">
                Working online with clients across New Farm and greater Brisbane, I often hear patients ask: <strong>"Mitch, what does my gut have to do with my mood?"</strong>
              </p>
