  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-background">
      ...
      <SEO 
        ...
        canonical="/naturopathy-in-brisbane"
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {[
              ...
              { step: 2, title: "Your First Real Appointment (1 Hour)", desc: "This is where the **real healing begins**. You will sit down with Mitch on a video call. You will have a **full hour** to tell him everything. He will listen to your whole story. By the end, you will have a **clear, custom health plan** made just for you." },
...
export default NaturopathyInBrisbane;
