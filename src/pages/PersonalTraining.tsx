  ...
  return <>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
            ...
            <div className="relative hidden lg:block">
              <img alt="Expert personal trainer newstead guiding client through customized fitness program with professional equipment" className="rounded-2xl shadow-2xl w-full h-auto" src="/lovable-uploads/dd4ff0ea-d4e7-416c-b0d9-d3a541758d60.png" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="lg:hidden mb-12">
            <img src="/lovable-uploads/c27cfaf2-b8ca-4803-a8dc-56755e37f880.png" alt="NXTLVL Health naturopath Mitch providing personalized training consultation and exercise guidance" className="rounded-2xl shadow-lg w-full h-auto mx-auto" />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            {/* Desktop Image */}
            <div className="relative hidden lg:block">
              <img src="/lovable-uploads/c27cfaf2-b8ca-4803-a8dc-56755e37f880.png" alt="Dual-qualified exercise scientist and naturopath conducting fitness assessment and movement analysis" className="rounded-2xl shadow-lg w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img src="/lovable-uploads/ebe57be4-34e5-44ef-a092-f4c535a3e714.png" alt="Qualified fitness trainer demonstrating correct exercise technique and proper form for strength training" className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" />
          </div>
        </div>
      </section>
