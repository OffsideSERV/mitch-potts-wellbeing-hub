...
const IBSTreatmentBrisbane = () => {
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <div className="absolute -bottom-6 left-2 bg-white p-4 rounded-xl shadow-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Natural Healing • Brisbane</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Natural Healing • Brisbane</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class Name="container mx-auto max-w-6xl">
          ...
          <div className="lg:hidden mb-12">
            <img 
              ...
              alt="Woman experiencing IBS symptoms seeking treatment in Brisbane" 
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="IBS diagnosis and testing at NXTLVL Health Brisbane" 
            ...
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Constipation predominant IBS</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Diarrhoea predominant IBS</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Mixed IBS (constipation and diarrhoea)</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Abdominal pain and cramping</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Bloating and gas</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Changes in bowel habits (constipation, diarrhoea, or both)</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Feeling full or nauseous after eating</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Fatigue and poor sleep</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Food reactions or food intolerances</span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="IBS causes and triggers discussion at NXTLVL Health" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
      ...
      {/* Our IBS Treatment Approach Section */}
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="Mitch Potts providing IBS treatment at NXTLVL Health Brisbane" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <Card className="bg-white shadow-md">
              <CardHeader>
                <CardTitle className="text-xl text-primary">Step 3: We Build Your Personalised Treatment Plan</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
            ...
            <Card className="bg-white shadow-md">
              <CardHeader>
                <CardTitle className="text-xl text-primary">Step 4: We Heal</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
            ...
            <Card className="bg-white shadow-md">
              <CardHeader>
                <CardTitle className="text-xl text-primary">Step 5: We Support You Long-Term</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="NXTLVL Health clinic facilities for IBS treatment in Brisbane" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
            ...
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Personalised care – Every plan is built just for you</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Gut-brain connection support – We understand how stress, anxiety, and mental health impact gut issues</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Modern testing – Get insights into your gut that GPs often miss</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Natural medicine – We focus on root cause healing, not symptom-masking</span>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-md lg:col-span-2">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-muted-foreground">Compassionate guidance – You'll feel heard, seen, and supported</span>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="IBS impact assessment at NXTLVL Health Brisbane" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="IBS natural treatment solutions at NXTLVL Health" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
      ...
      {/* Time to Restore Balance Section */}
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
          ...
          <div className="mb-12">
            <img 
              ...
              alt="Restoring balance and wellness at NXTLVL Health Brisbane" 
              className="rounded-2xl shadow-lg w-full max-w-2xl mx-auto h-auto" 
            />
          </div>
